...
Run com.adityaebs.rest.webservices.restfulwebservices.RestfulWebServicesApplication as a Java Application.
...
artifacts:
  files:
    - target/spring-boot-task-rest-api-h2-aws-codepipeline-0.0.1-SNAPSHOT.jar
```